...
def _generate_examples():
    preds_path = os.path.join(os.getcwd(),
                              "../DATA/xfund-and-funsd/models/test-ner-xfund/test_predictions.txt")  # 对齐后的实体识别结果
    ...
    filepaths = [[os.path.join(os.getcwd(), '../DATA/xfund-and-funsd/XFUND-and-FUNSD/zh.val.align.json'),
                  os.path.join(os.getcwd(), '../DATA/xfund-and-funsd/XFUND-and-FUNSD/zh.val')]]
    items = []
